...
namespace com.IvanMurzak.Godot.MCP.GridMap
{
    public partial class Tool_GridMap
    {
        ...
        public const string EditorInfoToolId = "gridmap-editor-info";
        ...
        /// gridmap-editor-info</c>), NOT by the pure-managed unit tests — a plain xUnit host
        ...
        (
            EditorInfoToolId,
            Title = "GridMap Tools / Editor Info",
            ReadOnlyHint = true,
            IdempotentHint = true,
            OpenWorldHint = false
        )]
        [Description("Sample editor-only tool for the GridMap Tools extension. Returns the running " +
